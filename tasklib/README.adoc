...
* `<<filters>>`            generate and aot-comile "meta-filter" files
...
* `<<reloader>>`	   generate and aot-compile reloader filter
* `<<run>>`		   run devappserver
* `<<servlets>>`	   generate and aot-compile "meta-servlet" files
