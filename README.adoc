...
* link:examples/greetings[greetings] demonstrates multiple servlets and filters. uses compojure.
* link:examples/services[services] demonstrates implementation of https://cloud.google.com/appengine/docs/java/modules/[GAE Services] (formerly "Modules").
...
Task library documentation: link:tasklib/README.adoc[tasks]
